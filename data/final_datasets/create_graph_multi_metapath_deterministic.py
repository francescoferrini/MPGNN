...
def main(args):
    ...
    # Create a directory to save files
        path = '/Users/francescoferrini/VScode/MPGNN/data/final_datasets/metapath_length_3/overlap_0_rels_0'
    else: 
        path = '/Users/francescoferrini/VScode/MPGNN/data/final_datasets/metapath_length_2/overlap_2_rels_2'
